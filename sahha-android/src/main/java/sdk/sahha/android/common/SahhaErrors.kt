...
internal object SahhaErrors {
    ...
    const val postingInProgress =
        "Error: There is already a post in progress, please try again shortly"
    ...
    const val sensorStatsNotSupported = "Error: Stats not supported for this sensor"
    const val sensorNoStatsFound = "Error: No stats found for this sensor"
    const val sensorSamplesNotSupported = "Error: Samples not supported for this sensor"
